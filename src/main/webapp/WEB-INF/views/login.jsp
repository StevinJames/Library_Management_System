            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form:form modelAttribute="loginObj" action="doLogin" method="post">
							...
							<div class="form-floating">
  								<form:password class="form-control" id="floatingPassword" placeholder="Password" path="password"/>
  								<form:label for="floatingPassword" path="password">Password</form:label>
							</div>

                             <button type="submit" class="btn btn-primary w-100 mt-3">Login</button>
                        </form:form>
                        Don't have an account?<a href="user/register">Sign in</a>
